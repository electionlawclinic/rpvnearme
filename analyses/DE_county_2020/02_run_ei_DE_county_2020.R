###############################################################################
# Run EI for `DE_county_2020`
# © Election Law Clinic, Harvard Law School, November 2022
###############################################################################

# Run the simulation -----
cli_process_start('Running EI analysis for {.pkg DE_county_2020}...')
...
write_rds(ei_l, here('data-out/DE_2020/DE_county_2020_ei_b.rds'), compress = 'xz')
