###############################################################################
# Run EI for `IA_county_2020`
# © Election Law Clinic, Harvard Law School, September 2023
###############################################################################

# Run the simulation -----
cli_process_start('Running EI analysis for {.pkg IA_county_2020}...')
...
write_rds(ei_l, here('data-out/IA_2020/IA_county_2020_ei_b.rds'), compress = 'xz')
