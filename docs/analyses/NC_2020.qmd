...
ei_tb <- read_csv(str_glue('https://raw.githubusercontent.com/electionlawclinic/rpvnearme/main/data/{abb}_county_2020_summary.csv'))
...
tibble(
  name = c('Summary File', 'Precinct Estimates'),
  url = c(
