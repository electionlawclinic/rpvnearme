---
title: "South Carolina 2020"
description: |
  Ecological inference estimates by county for SC State.
format: html
---
...
ei_tb <- read_csv(str_glue('../../data/{abb}_county_2020_summary_b.csv'))
...
Source: 2016–2020 estimates from Voting and Election Science Team precinct returns aligned by the ALARM Project. 2024 estimates from Redistricting Data Hub, Benjamin J. Rosenblatt and `@cincy9`, Christopher T. Kenny, and Josh Metcalf.

{{< include ../../analyses/SC_county_2020/doc_SC_county_2020.md >}}
